package body Song is
   ...
   package body Constructors is
      ...
      function Initialize return T_Song is
        (T_Song'
           (Id             => Null_Unbounded_String,
            ...
            Provider       => Api_Provider.No_Provider));
      ...
      function Initialize
        (Id             : in String;
         ...
         Provider       : in Api_Provider.T_Api_Provider) return T_Song is
        (T_Song'
   ...
   -- Get_Provider
   -------------------------------------------------------------------------------------------------
   function Get_Provider (This : in T_Song) return Api_Provider.T_Api_Provider is (This.Provider);
